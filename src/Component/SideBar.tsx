...
export const SideBar = () => {
    ...
    return(
        <div className="w-27 bg-base-dark-bg-2 items-center hidden md:flex flex-col justify-around">
            <div className={` w-full p-3 hover:cursor-pointer ${appPage === "Dashboard" ? "bg-base-dark-bg-1 rounded-s-md" : ""}`}>
            ...
            <div className={`p-3 hover:cursor-pointer ${appPage === "PurchaseGraph" ? "bg-base-dark-bg-1 rounded-s-md" : ""}`}>
                <div className={`p-2
            ...
            <div className={`p-3 hover:cursor-pointer ${appPage === "Setting" ? "bg-base-dark-bg-1 rounded-s-md" : ""}
            `}>
